...
const BookRide = () => {
        ...
        return (
                <StripeProvider publishableKey={process.env.EXPO_PUBLIC_STRIPE_PUBLISHABLE_KEY!} merchantIdentifier="merchant.com.uber" urlScheme="myapp">
                                ...
                                <>
                                        ...
                                        <View className="flex flex-col w-full items-start justify-center py-3 px-5 rounded-3xl bg-general-600 mt-5">
                                                ...
                                                <View className="flex flex-row items-center justify-between w-full border-b border-white py-3">
                                                        ...
                                                        <Text className="text-lg font-JakartaRegular">{formatTime(parseInt(`${driverDetails.time}`))}</Text>
                                                </View>
