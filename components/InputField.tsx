                ...
                <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
                        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                                <View className="my-2 w-full">
                                        ...
                                        >
                                                {icon && <Image className={`w-6 h-6 ml-4 ${iconStyle}`} source={icon} />}
                                                <TextInput className={`rounded-full p-4 font-JakartaSemiBold text-lg flex-1 ${inputStyle} text-left`} secureTextEntry={secureTextEntry} {...props} />
                                        </View>
                                </View>
